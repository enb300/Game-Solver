...
class WordList {
    let words: [String] = [
        ...
        "crowd", "crown", "crude", "carry", "curly", "curry", "curse", "curve", "cycle", "daily",
        "dance", "dated", "dealt", "death", "debut", "delay", "depth", "doing", "doubt", "dozen",
        "draft", "drama", "drank", "drawl", "drawn", "dream", "dress", "drill", "drink", "drive",
        ...
        "raise", "range", "rapid", "ratio", "reach", "ready", "realm", "rebel", "refer", "right",
